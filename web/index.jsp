        ...
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                    ...
                    <span class="fs-4">Novo Curso MVC</span>
                </a>
                ...
                <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    ...
                    <a class="py-2 text-dark text-decoration-none" href="admCursos.jsp">Administrador</a>
                </nav>
            </div>

            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-4 fw-normal">Alfa Cursos OnLine</h1>
                <p class="fs-5 text-muted">Turmas reduzidas, aulas com transmisṣo ao vivo. O aluno pode rever ou mesmo assistir de casa quando quiser.</p>
            </div>
        </header>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <a href="detalhes.jsp?idc=${linha.codigo}" class="w-100 btn btn-lg btn-outline-primary">Ver detalhes</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
